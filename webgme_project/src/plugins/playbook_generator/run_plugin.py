"""
This script is called by the plugin-wrapper, playbook_generator.js, which passes down the
...
plugin = playbook_generator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
