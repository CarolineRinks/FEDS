"""
This script is called by the plugin-wrapper, credential_file_generator.js, which passes down the
...
from credential_file_generator import credential_file_generator

logger = logging.getLogger('credential_file_generator')
...
plugin = credential_file_generator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
