"""
This script is called by the plugin-wrapper, create_credential_file.js, which passes down the
...
from create_credential_file import create_credential_file

logger = logging.getLogger('create_credential_file')
...
plugin = create_credential_file(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
