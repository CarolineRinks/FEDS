"""
This script is called by the plugin-wrapper, apply.js, which passes down the
...
plugin = apply(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
