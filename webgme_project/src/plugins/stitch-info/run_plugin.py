"""
This script is called by the plugin-wrapper, stitch-info.js, which passes down the
...
from stitch-info import stitch-info

logger = logging.getLogger('stitch-info')
...
plugin = stitch-info(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
