"""
This script is called by the plugin-wrapper, fabfed_config_generator.js, which passes down the
...
from fabfed_config_generator import fabfed_config_generator
...
plugin = fabfed_config_generator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
