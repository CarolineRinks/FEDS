"""
This script is called by the plugin-wrapper, plan_summary.js, which passes down the
...
from plan_summary import plan_summary

logger = logging.getLogger('plan_summary')
...
plugin = plan_summary(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
