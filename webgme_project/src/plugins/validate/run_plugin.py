"""
This script is called by the plugin-wrapper, validate.js, which passes down the
...
plugin = validate(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
